...
<body style="    background-color: #06C167;">
    ...
    <form action="" method="post">
       ...
       <div class="input">
        ...
        <div class="input">
        <label for="quantity">Quantity:(how many people will be served)</label>
...
<option value="">--select--</option>
  ...
  <option value="kanniyakumari">Kanniyakumari</option>-->
        ...
        <input type="text" id="address" placeholder="from where food to be collect..." name="address" required/><br>
      ...
      <?php 
        ...
        //$food=$_SESSION['food'];
        $query="select * from food_donations where email='$email1'  ";
